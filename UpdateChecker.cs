...
namespace DeleteThatEntityPlugin
{
    ...
    {
        private static readonly string pluginKey = "DeleteThatEntity";
        private static readonly InitializationFile updateSettings = new InitializationFile("Plugins/SSStuart_UpdateChecker.ini");

        private static readonly string url = "https://ssstuart.net/api/GTAModVersion/Delete%20That%20Entity";
